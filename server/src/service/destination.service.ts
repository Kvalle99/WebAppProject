...
import { filterOnSearchCityCountry } from "./searching.service";
...
export class DestinationService implements IDestinationService {
  ...
  destinations: Destination[] = [
    ...
    new Destination(
      ...
      "Thailand",
      "Has great jungles.",
      "https://a.cdn-hotels.com/gdcs/production9/d679/184d7edf-5c3a-470c-8529-b0085d6d5b0e.jpg?impolicy=fcrop&w=800&h=533&q=medium"
    ),
    new Destination(
      "Paris",
      "France",
      "Experience the best of French culture",
    ...
    new Destination(
      ...
      "Sweden",
      "Best accent, enna!",
      "https://www.boktugg.se/wp-content/uploads/2019/01/Goteborg-sparvagn-iStock-495376272.jpg"
    ),
    new Destination(
      "Stockholm",
      "Sweden",
      "Not recommended if you like fun",
      "https://media.timeout.com/images/105171709/image.jpg"
    ),
    new Destination(
      "Madrid",
      "Spain",
      "Maybe go for some tapas?",
      "https://www.folkuniversitetet.se/contentassets/2b5398e3897f41eb9906a1fbb6063fc7/spanska-madrid.jpg?preset=article600"
    ),
  ];
  ...
  getDestinations(searchText: string): Destination[] {
    let matchingDestinations = filterOnSearchCityCountry(
      this.destinations,
      searchText
    );
